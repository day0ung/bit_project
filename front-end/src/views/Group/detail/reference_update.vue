    ...
    methods:{
        ...
        submitForm(formName) {
			...
			if (valid) {
                ...
                formData.append('boardSeq', this.$store.state.s_group.groupReferenceDetail.boardSeq)
                ...
                //     console.log(`${key}`)
                // }
				axios.post("http://localhost:9000/updateGroupReference", formData ,{
					headers:{
