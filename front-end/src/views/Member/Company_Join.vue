	...
	<div class="ndls_bwrite join_write">
		<div class="box w100">
			<ul>
				...
				<li>
					<dl>
						<dt><span class="red">*</span> <label for="exchange_mobile">회사 번호</label></dt>
						<dd>
				...
				<li>
					<dl>
						<dt><label for="user_pwd_chk">회사명</label></dt>
						<dd>
                ...
                <li>
					<dl>
						<dt><label for="user_pwd_chk">회사소개</label></dt>
						<dd>
                            <textarea v-model="introduce" cols="90" rows="10"></textarea>
						</dd>
					</dl>
				</li>
			</ul>
